...
your actual Knex migration should use snake_case table/column names
(`couriers`, `work_id`, `courier_id`, etc.) per standard SQL convention.
...
- **Order status is a strict state machine**, enforced in the service layer, not
